...
import net.gowaka.gowaka.network.client.model.GlobalErrorMessage;
 ...
 */
@Component
public class GlobalRestTemplateResponseErrorHandler implements ResponseErrorHandler {
    @Override
    ...
    public void handleError(ClientHttpResponse clientHttpResponse) throws IOException {
        ...
        GlobalErrorMessage errorResponse = null;
        String content = null;
        ...
        switch (clientHttpResponse.getStatusCode()) {
            ...
            case UNPROCESSABLE_ENTITY:
                ...
                errorResponse = new ObjectMapper().readValue(content, GlobalErrorMessage.class);
