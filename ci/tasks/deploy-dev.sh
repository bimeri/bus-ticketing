...
ldc ldc add-env GoWakaEnv -n APP_NAME -v $APP_NAME
ldc ldc add-env GoWakaEnv -n APP_CLIENT_ID -v $APP_CLIENT_ID
ldc ldc add-env GoWakaEnv -n APP_CLIENT_SECRET -v $APP_CLIENT_SECRET
